/**
 * Output ports for the Customer bounded context.
 *
 * <p>Interfaces the application layer depends on for persistence and other outbound
 * collaboration. Outbound adapters under
 * {@link com.systemdesignlab.platform.customer.adapter.out.persistence} implement these
...
package com.systemdesignlab.platform.customer.port.out;
