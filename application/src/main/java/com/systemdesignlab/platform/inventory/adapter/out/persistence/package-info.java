/**
 * Outbound persistence adapters for the Inventory bounded context.
 *
 * <p>Implements {@link com.systemdesignlab.platform.inventory.port.out} against this module's
...
package com.systemdesignlab.platform.inventory.adapter.out.persistence;
