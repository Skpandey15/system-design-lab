/**
 * Application layer for the Catalog bounded context.
 *
 * <p>Hosts use-case orchestration services that coordinate the domain model through
 * {@link com.systemdesignlab.platform.catalog.port.out} output ports. Must not depend on
...
package com.systemdesignlab.platform.catalog.application;
