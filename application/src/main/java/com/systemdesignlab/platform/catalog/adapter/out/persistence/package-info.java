/**
 * Outbound persistence adapters for the Catalog bounded context.
 *
 * <p>Implements {@link com.systemdesignlab.platform.catalog.port.out} against this module's
...
package com.systemdesignlab.platform.catalog.adapter.out.persistence;
