/**
 * Application layer for the Order bounded context.
 *
 * <p>Hosts use-case orchestration services that coordinate the domain model through
 * {@link com.systemdesignlab.platform.order.port.out} output ports. Must not depend on
...
package com.systemdesignlab.platform.order.application;
