/**
 * Application layer for the Cart bounded context.
 *
 * <p>Hosts use-case orchestration services that coordinate the domain model through
 * {@link com.systemdesignlab.platform.cart.port.out} output ports. Must not depend on
...
package com.systemdesignlab.platform.cart.application;
