/**
 * Payment bounded context: Payment intent/authorization record and payment lifecycle, sequenced outside the order's DB transaction.
 *
 ...
 */
package com.systemdesignlab.platform.payment;
