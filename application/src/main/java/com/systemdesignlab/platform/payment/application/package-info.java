/**
 * Application layer for the Payment bounded context.
 *
 * <p>Hosts use-case orchestration services that coordinate the domain model through
 * {@link com.systemdesignlab.platform.payment.port.out} output ports. Must not depend on
...
package com.systemdesignlab.platform.payment.application;
