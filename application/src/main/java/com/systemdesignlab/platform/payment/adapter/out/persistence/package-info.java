/**
 * Outbound persistence adapters for the Payment bounded context.
 *
 * <p>Implements {@link com.systemdesignlab.platform.payment.port.out} against this module's
...
package com.systemdesignlab.platform.payment.adapter.out.persistence;
